...
// run*·parse*는 async (UI 프리징 방지용 주기 yield) — 시나리오 전체를 async 컨텍스트에서 실행
(async () => {
...
const rep1 = await T.runExamCheckHwpx('inline');
...
const stats1 = await T.runAnswerStatsHwpx('inline');
...
const rep2 = await T.runExamCheckHwpx('inline');
...
const rep3 = await T.runExamCheckHwpx('inline');
...
const rep4 = await T.runExamCheckHwpx('footer');
...
const rep5 = await T.runExamCheckHwpx('inline');
...
const stats6 = await T.runAnswerStatsHwpx('inline');
...
const rep7 = await T.runExamCheckHwpx('footer');
...
const rep8 = await T.runExamCheckHwpx('inline');
...
const rep9 = await T.runExamCheckHwpx('footer');
...
const statsE = await T.runAnswerStatsHwpx('inline');
...
const statsE3 = await T.runAnswerStatsHwpx('inline');
